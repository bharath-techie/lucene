...
public abstract class CodecReader extends LeafReader {
  ...
  public abstract DataCubesProducer<?> getDataCubesReader();
  ...
  public final Object getAggregatedDocValues() throws IOException {
    return getDataCubesReader().getDataCubeValues("field-name-placeholder");
  ...
  public DataCubeValues<?> getDataCubeValues(String field) throws IOException {
    ensureOpen();
    return getDataCubesReader().getDataCubeValues(field);
  }
