...
public class StarTreeFilter {
  ...
  Map<String, List<Predicate<Integer>>> _predicateEvaluators;
  ...
  private StarTreeResult traverseStarTree() throws IOException {
    ...
    while ((starTreeNode = queue.poll()) != null) {
      ...
      if ((globalRemainingPredicateColumns == null
              || !globalRemainingPredicateColumns.contains(childDimension))
      ...
      if (remainingPredicateColumns.contains(childDimension)) {
        ...
        if (starNode != null) {
          ...
          while (childrenIterator.hasNext()) {
            ...
            List<Predicate<Integer>> predicates = _predicateEvaluators.get(childDimension);
            for (Predicate<Integer> predicate : predicates) {
              int val = childNode.getDimensionValue();
    ...
    return new StarTreeResult(
        docsWithField,
        globalRemainingPredicateColumns != null
            ? globalRemainingPredicateColumns
