...
// import static
// org.apache.lucene.codecs.freshstartree.node.OffHeapStarTreeNode.SERIALIZABLE_SIZE_IN_BYTES;
...
public class StarTreeBuilderUtils {
  ...
  public static void serializeTree(
      IndexOutput indexOutput, TreeNode rootNode, String[] dimensions, int numNodes)
      throws IOException {
    ...
    // System.out.println("Star tree size in bytes : " + totalSizeInBytes);
  ...
  private static void writeHeader(
      IndexOutput output, int headerSizeInBytes, String[] dimensions, int numNodes)
      throws IOException {
  ...
  private static void writeNode(
      IndexOutput output, TreeNode node, int firstChildId, int lastChildId) throws IOException {
    output.writeInt(node._dimensionId);
    output.writeInt(node._dimensionValue);
