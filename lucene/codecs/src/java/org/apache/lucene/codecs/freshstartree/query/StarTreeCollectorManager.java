...
/** TODO : remove this ? */
public class StarTreeCollectorManager
    implements CollectorManager<StarTreeCollector, StarTreeCollector> {
  @Override
  public StarTreeCollector newCollector() throws IOException {
    return new StarTreeCollector();
  }

  @Override
  public StarTreeCollector reduce(Collection<StarTreeCollector> collectors) throws IOException {
